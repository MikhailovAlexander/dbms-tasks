# Пробное задание для работы с СУБД
Разработать структуру базы данных для учебного заведения
* Создать таблицы для хранения информации о студентах, группах и поле (половой принадлежности).
* Установить связи между таблицами через внешние ключи.
* Добавить ограничения целостности, такие как уникальные значения (для групп и пола) и первичные ключи.
